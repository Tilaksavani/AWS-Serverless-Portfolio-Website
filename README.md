...
![API Gateway endpoint](screenshots/API_Gateway_endpoint.png)
...
![DynamoDB saved message](screenshots/DynamoDB_saved_message.png)
...
![AWS Budget alert](screenshots/AWS_Budget_alert.png)
